...
//  breakfix_ios
//
//  Created by Trent Poche on 5/2/13.
...
- (id)initWithStyle:(UITableViewStyle)style
{
    ...
    if (self) {
        ...
        //self.title = @"Current Prescriptions";
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Configure the cell...
	ElixrPrescription *script = [self.prescriptions objectAtIndex:indexPath.row];
	cell.textLabel.text = script.drugName;
